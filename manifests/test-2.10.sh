...
main() {
    ...
    curl -L  https://raw.githubusercontent.com/jamest-portainer/testing/main/manifests/edge-2.10.yaml -o portainer-agent-edge-k8s.yaml || errorAndExit "Unable to download agent manifest"
