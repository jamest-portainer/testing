...
main() {
    ...
    curl -L  https://raw.githubusercontent.com/jamest-portainer/testing/main/manifests/kube/pa2.yaml -o pa2.yaml || errorAndExit "Unable to download agent manifest"
