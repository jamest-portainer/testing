...
main() {
    ...
    curl -L  https://raw.githubusercontent.com/jamest-portainer/testing/main/manifests/kube/deployportainer/edge.yaml -o portainer-agent-edge-k8s.yaml || errorAndExit "Unable to download agent manifest"
